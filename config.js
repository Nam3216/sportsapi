...
module.exports={
 PORT:process.env.PORT || 3006,//aca digo q el puerto por defecto es 3000, el servicio web tipo railway puede dar otro. process es propio de reailw, se fija si existe PORT, SI ESTA es q el servicio ya dejo un entorno para conectarse, sino es 3000 del localhost
